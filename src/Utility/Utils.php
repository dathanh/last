...
class Utils {
    ...
    public static function useTables($obj, $tableNames = []) {
        ...
        foreach ($tableNames as $tableName) {
            ...
            if (isset(CoreController::$_globalObjects['tables'][$tableClass]) && !empty(CoreController::$_globalObjects['tables'][$tableClass])) {
                $obj->$tableName = CoreController::$_globalObjects['tables'][$tableClass];
            } else {
                $table = TableRegistry::get($tableName);
                if (!empty($table)) {
                    $obj->$tableClass = CoreController::$_globalObjects['tables'][$tableClass] = $table;
                }
            }
    ...
    public static function useComponents($obj, $componentNames = []) {
        ...
        foreach ($componentNames as $componentName) {
            ...
            if (empty($controller)) {
                $controller = new CoreController(new \Cake\Network\Request(), new \Cake\Network\Response());
                $controller->initialize();
            }
            if (isset(CoreController::$_globalObjects['components'][$componentName]) && !empty(CoreController::$_globalObjects['components'][$componentName])) {
                $obj->$componentName = CoreController::$_globalObjects['components'][$componentName];
            } else {
                $pluginName = 'App';
                ...
                if (class_exists($componentClass)) {
                    ...
                    CoreController::$_globalObjects['components'][$componentName] = $obj->$componentName = $controller->$componentName;
                }
            }
